...
export interface ApiChapterChapter extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Ch\u01B0\u01A1ng h\u1ECDc - ch\u1EE9a nhi\u1EC1u B\u00E0i h\u1ECDc';
    displayName: 'Chapter';
    pluralName: 'chapters';
...
export interface ApiLessonLesson extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'B\u00E0i h\u1ECDc - thu\u1ED9c 1 Ch\u01B0\u01A1ng, ch\u1EE9a nhi\u1EC1u T\u1EEB v\u1EF1ng';
    displayName: 'Lesson';
    pluralName: 'lessons';
    singularName: 'lesson';
  };
...
export interface ApiWordWord extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'T\u1EEB v\u1EF1ng - thu\u1ED9c 1 B\u00E0i h\u1ECDc';
    displayName: 'Word';
    pluralName: 'words';
    singularName: 'word';
  };
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    hiragana: Schema.Attribute.String;
    katakana: Schema.Attribute.String;
    ...
    order: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    publishedAt: Schema.Attribute.DateTime;
    romaji: Schema.Attribute.String;
    sentence: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
